...
%	\newpage
	...
	\begin{itemize}
		...
		\item It's better to use BFS for finding cycles in undirected graphs. If we encounter a cross edge, we have a cycle. For directed graphs, it's better to use DFS. If we have a back edge, it means we have a cycle. If you want to use DFS for undirected graph see \textbf{Exercise 10 of DFS}.
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item BFS: We can have back edges.
			\end{itemize}
			\item Undirected graph
			\begin{itemize}
				\item DFS: We can have back edges
