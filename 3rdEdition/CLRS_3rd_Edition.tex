...
%	\newpage
	...
	For more information about Lemma 22.3 see the textbook. Suppose $Q = \{v_1, v_2, \dots , v_r\}$ as we defined it in Lemma 22.3. Note that if we encounter a back edge, it connects two vertices (u, v) that $u \notin Q \land v \in Q$. \\
